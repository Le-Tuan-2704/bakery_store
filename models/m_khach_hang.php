...
class M_khach_hang extends database {
    ...
    function Them_hoa_don($ma_san_pham, $ma_khach_hang, $ho_ten_nguoi_nhan, $sdt_nguoi_nhan, $dia_diem_giao, $ngay_dat_hang, $ngay_giao_hang, $trang_thai, $tong_gia, $ghi_chu) {
        $sql = "INSERT INTO bk_don_hang (ma_don_hang, ma_san_pham, ma_khach_hang, ho_ten_nguoi_nhan, sdt_nguoi_nhan, dia_diem_giao, ngay_dat_hang, ngay_giao_hang, trang_thai, tong_gia, ghi_chu) VALUES (NULL, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        
        return $this->pdo_execute($sql,[$ma_san_pham, $ma_khach_hang, $ho_ten_nguoi_nhan, $sdt_nguoi_nhan, $dia_diem_giao, $ngay_dat_hang, $ngay_giao_hang, $trang_thai, $tong_gia, $ghi_chu]);
    }
